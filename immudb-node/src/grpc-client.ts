...
import { ProtoGrpcType } from 'immudb-grpcjs'


import { createRequire } from 'node:module';
const require = createRequire(import.meta.url)

// const protoPath = import.meta.resolve?.('immudb-grpcjs/schema.proto')

const protoPath = require.resolve('immudb-grpcjs/schema.proto')
console.log("Proto path:", protoPath)

export const grpcClientFactory = createGrpcClientFactory(
    // new URL('../schema.proto', import.meta.url).toString()
    protoPath
    // 'schema.proto'
) 
