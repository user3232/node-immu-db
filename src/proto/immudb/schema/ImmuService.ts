...
import type { AuthConfig as _immudb_schema_AuthConfig, AuthConfig__Output as _immudb_schema_AuthConfig__Output } from '../../immudb/schema/AuthConfig.js';
import type { ChangePasswordRequest as _immudb_schema_ChangePasswordRequest, ChangePasswordRequest__Output as _immudb_schema_ChangePasswordRequest__Output } from '../../immudb/schema/ChangePasswordRequest.js';
import type { ChangePermissionRequest as _immudb_schema_ChangePermissionRequest, ChangePermissionRequest__Output as _immudb_schema_ChangePermissionRequest__Output } from '../../immudb/schema/ChangePermissionRequest.js';
import type { Chunk as _immudb_schema_Chunk, Chunk__Output as _immudb_schema_Chunk__Output } from '../../immudb/schema/Chunk.js';
...
import type { CreateDatabaseRequest as _immudb_schema_CreateDatabaseRequest, CreateDatabaseRequest__Output as _immudb_schema_CreateDatabaseRequest__Output } from '../../immudb/schema/CreateDatabaseRequest.js';
import type { CreateDatabaseResponse as _immudb_schema_CreateDatabaseResponse, CreateDatabaseResponse__Output as _immudb_schema_CreateDatabaseResponse__Output } from '../../immudb/schema/CreateDatabaseResponse.js';
import type { CreateUserRequest as _immudb_schema_CreateUserRequest, CreateUserRequest__Output as _immudb_schema_CreateUserRequest__Output } from '../../immudb/schema/CreateUserRequest.js';
...
import type { DatabaseHealthResponse as _immudb_schema_DatabaseHealthResponse, DatabaseHealthResponse__Output as _immudb_schema_DatabaseHealthResponse__Output } from '../../immudb/schema/DatabaseHealthResponse.js';
import type { DatabaseListRequestV2 as _immudb_schema_DatabaseListRequestV2, DatabaseListRequestV2__Output as _immudb_schema_DatabaseListRequestV2__Output } from '../../immudb/schema/DatabaseListRequestV2.js';
import type { DatabaseListResponse as _immudb_schema_DatabaseListResponse, DatabaseListResponse__Output as _immudb_schema_DatabaseListResponse__Output } from '../../immudb/schema/DatabaseListResponse.js';
import type { DatabaseListResponseV2 as _immudb_schema_DatabaseListResponseV2, DatabaseListResponseV2__Output as _immudb_schema_DatabaseListResponseV2__Output } from '../../immudb/schema/DatabaseListResponseV2.js';
import type { DatabaseSettings as _immudb_schema_DatabaseSettings, DatabaseSettings__Output as _immudb_schema_DatabaseSettings__Output } from '../../immudb/schema/DatabaseSettings.js';
import type { DatabaseSettingsRequest as _immudb_schema_DatabaseSettingsRequest, DatabaseSettingsRequest__Output as _immudb_schema_DatabaseSettingsRequest__Output } from '../../immudb/schema/DatabaseSettingsRequest.js';
import type { DatabaseSettingsResponse as _immudb_schema_DatabaseSettingsResponse, DatabaseSettingsResponse__Output as _immudb_schema_DatabaseSettingsResponse__Output } from '../../immudb/schema/DatabaseSettingsResponse.js';
import type { DeleteDatabaseRequest as _immudb_schema_DeleteDatabaseRequest, DeleteDatabaseRequest__Output as _immudb_schema_DeleteDatabaseRequest__Output } from '../../immudb/schema/DeleteDatabaseRequest.js';
import type { DeleteDatabaseResponse as _immudb_schema_DeleteDatabaseResponse, DeleteDatabaseResponse__Output as _immudb_schema_DeleteDatabaseResponse__Output } from '../../immudb/schema/DeleteDatabaseResponse.js';
import type { DeleteKeysRequest as _immudb_schema_DeleteKeysRequest, DeleteKeysRequest__Output as _immudb_schema_DeleteKeysRequest__Output } from '../../immudb/schema/DeleteKeysRequest.js';
...
import type { Entries as _immudb_schema_Entries, Entries__Output as _immudb_schema_Entries__Output } from '../../immudb/schema/Entries.js';
import type { Entry as _immudb_schema_Entry, Entry__Output as _immudb_schema_Entry__Output } from '../../immudb/schema/Entry.js';
import type { EntryCount as _immudb_schema_EntryCount, EntryCount__Output as _immudb_schema_EntryCount__Output } from '../../immudb/schema/EntryCount.js';
import type { ExecAllRequest as _immudb_schema_ExecAllRequest, ExecAllRequest__Output as _immudb_schema_ExecAllRequest__Output } from '../../immudb/schema/ExecAllRequest.js';
import type { ExportTxRequest as _immudb_schema_ExportTxRequest, ExportTxRequest__Output as _immudb_schema_ExportTxRequest__Output } from '../../immudb/schema/ExportTxRequest.js';
import type { FlushIndexRequest as _immudb_schema_FlushIndexRequest, FlushIndexRequest__Output as _immudb_schema_FlushIndexRequest__Output } from '../../immudb/schema/FlushIndexRequest.js';
import type { FlushIndexResponse as _immudb_schema_FlushIndexResponse, FlushIndexResponse__Output as _immudb_schema_FlushIndexResponse__Output } from '../../immudb/schema/FlushIndexResponse.js';
import type { HealthResponse as _immudb_schema_HealthResponse, HealthResponse__Output as _immudb_schema_HealthResponse__Output } from '../../immudb/schema/HealthResponse.js';
import type { HistoryRequest as _immudb_schema_HistoryRequest, HistoryRequest__Output as _immudb_schema_HistoryRequest__Output } from '../../immudb/schema/HistoryRequest.js';
import type { ImmutableState as _immudb_schema_ImmutableState, ImmutableState__Output as _immudb_schema_ImmutableState__Output } from '../../immudb/schema/ImmutableState.js';
import type { KeyListRequest as _immudb_schema_KeyListRequest, KeyListRequest__Output as _immudb_schema_KeyListRequest__Output } from '../../immudb/schema/KeyListRequest.js';
import type { KeyPrefix as _immudb_schema_KeyPrefix, KeyPrefix__Output as _immudb_schema_KeyPrefix__Output } from '../../immudb/schema/KeyPrefix.js';
import type { KeyRequest as _immudb_schema_KeyRequest, KeyRequest__Output as _immudb_schema_KeyRequest__Output } from '../../immudb/schema/KeyRequest.js';
import type { LoadDatabaseRequest as _immudb_schema_LoadDatabaseRequest, LoadDatabaseRequest__Output as _immudb_schema_LoadDatabaseRequest__Output } from '../../immudb/schema/LoadDatabaseRequest.js';
import type { LoadDatabaseResponse as _immudb_schema_LoadDatabaseResponse, LoadDatabaseResponse__Output as _immudb_schema_LoadDatabaseResponse__Output } from '../../immudb/schema/LoadDatabaseResponse.js';
import type { LoginRequest as _immudb_schema_LoginRequest, LoginRequest__Output as _immudb_schema_LoginRequest__Output } from '../../immudb/schema/LoginRequest.js';
import type { LoginResponse as _immudb_schema_LoginResponse, LoginResponse__Output as _immudb_schema_LoginResponse__Output } from '../../immudb/schema/LoginResponse.js';
import type { MTLSConfig as _immudb_schema_MTLSConfig, MTLSConfig__Output as _immudb_schema_MTLSConfig__Output } from '../../immudb/schema/MTLSConfig.js';
import type { NewTxRequest as _immudb_schema_NewTxRequest, NewTxRequest__Output as _immudb_schema_NewTxRequest__Output } from '../../immudb/schema/NewTxRequest.js';
import type { NewTxResponse as _immudb_schema_NewTxResponse, NewTxResponse__Output as _immudb_schema_NewTxResponse__Output } from '../../immudb/schema/NewTxResponse.js';
import type { OpenSessionRequest as _immudb_schema_OpenSessionRequest, OpenSessionRequest__Output as _immudb_schema_OpenSessionRequest__Output } from '../../immudb/schema/OpenSessionRequest.js';
import type { OpenSessionResponse as _immudb_schema_OpenSessionResponse, OpenSessionResponse__Output as _immudb_schema_OpenSessionResponse__Output } from '../../immudb/schema/OpenSessionResponse.js';
import type { ReferenceRequest as _immudb_schema_ReferenceRequest, ReferenceRequest__Output as _immudb_schema_ReferenceRequest__Output } from '../../immudb/schema/ReferenceRequest.js';
import type { SQLExecRequest as _immudb_schema_SQLExecRequest, SQLExecRequest__Output as _immudb_schema_SQLExecRequest__Output } from '../../immudb/schema/SQLExecRequest.js';
import type { SQLExecResult as _immudb_schema_SQLExecResult, SQLExecResult__Output as _immudb_schema_SQLExecResult__Output } from '../../immudb/schema/SQLExecResult.js';
import type { SQLQueryRequest as _immudb_schema_SQLQueryRequest, SQLQueryRequest__Output as _immudb_schema_SQLQueryRequest__Output } from '../../immudb/schema/SQLQueryRequest.js';
import type { SQLQueryResult as _immudb_schema_SQLQueryResult, SQLQueryResult__Output as _immudb_schema_SQLQueryResult__Output } from '../../immudb/schema/SQLQueryResult.js';
import type { ScanRequest as _immudb_schema_ScanRequest, ScanRequest__Output as _immudb_schema_ScanRequest__Output } from '../../immudb/schema/ScanRequest.js';
import type { SetActiveUserRequest as _immudb_schema_SetActiveUserRequest, SetActiveUserRequest__Output as _immudb_schema_SetActiveUserRequest__Output } from '../../immudb/schema/SetActiveUserRequest.js';
import type { SetRequest as _immudb_schema_SetRequest, SetRequest__Output as _immudb_schema_SetRequest__Output } from '../../immudb/schema/SetRequest.js';
import type { Table as _immudb_schema_Table, Table__Output as _immudb_schema_Table__Output } from '../../immudb/schema/Table.js';
import type { Tx as _immudb_schema_Tx, Tx__Output as _immudb_schema_Tx__Output } from '../../immudb/schema/Tx.js';
import type { TxHeader as _immudb_schema_TxHeader, TxHeader__Output as _immudb_schema_TxHeader__Output } from '../../immudb/schema/TxHeader.js';
import type { TxList as _immudb_schema_TxList, TxList__Output as _immudb_schema_TxList__Output } from '../../immudb/schema/TxList.js';
import type { TxRequest as _immudb_schema_TxRequest, TxRequest__Output as _immudb_schema_TxRequest__Output } from '../../immudb/schema/TxRequest.js';
import type { TxScanRequest as _immudb_schema_TxScanRequest, TxScanRequest__Output as _immudb_schema_TxScanRequest__Output } from '../../immudb/schema/TxScanRequest.js';
import type { UnloadDatabaseRequest as _immudb_schema_UnloadDatabaseRequest, UnloadDatabaseRequest__Output as _immudb_schema_UnloadDatabaseRequest__Output } from '../../immudb/schema/UnloadDatabaseRequest.js';
import type { UnloadDatabaseResponse as _immudb_schema_UnloadDatabaseResponse, UnloadDatabaseResponse__Output as _immudb_schema_UnloadDatabaseResponse__Output } from '../../immudb/schema/UnloadDatabaseResponse.js';
import type { UpdateDatabaseRequest as _immudb_schema_UpdateDatabaseRequest, UpdateDatabaseRequest__Output as _immudb_schema_UpdateDatabaseRequest__Output } from '../../immudb/schema/UpdateDatabaseRequest.js';
import type { UpdateDatabaseResponse as _immudb_schema_UpdateDatabaseResponse, UpdateDatabaseResponse__Output as _immudb_schema_UpdateDatabaseResponse__Output } from '../../immudb/schema/UpdateDatabaseResponse.js';
import type { UseDatabaseReply as _immudb_schema_UseDatabaseReply, UseDatabaseReply__Output as _immudb_schema_UseDatabaseReply__Output } from '../../immudb/schema/UseDatabaseReply.js';
import type { UserList as _immudb_schema_UserList, UserList__Output as _immudb_schema_UserList__Output } from '../../immudb/schema/UserList.js';
import type { VerifiableEntry as _immudb_schema_VerifiableEntry, VerifiableEntry__Output as _immudb_schema_VerifiableEntry__Output } from '../../immudb/schema/VerifiableEntry.js';
import type { VerifiableGetRequest as _immudb_schema_VerifiableGetRequest, VerifiableGetRequest__Output as _immudb_schema_VerifiableGetRequest__Output } from '../../immudb/schema/VerifiableGetRequest.js';
import type { VerifiableReferenceRequest as _immudb_schema_VerifiableReferenceRequest, VerifiableReferenceRequest__Output as _immudb_schema_VerifiableReferenceRequest__Output } from '../../immudb/schema/VerifiableReferenceRequest.js';
import type { VerifiableSQLEntry as _immudb_schema_VerifiableSQLEntry, VerifiableSQLEntry__Output as _immudb_schema_VerifiableSQLEntry__Output } from '../../immudb/schema/VerifiableSQLEntry.js';
import type { VerifiableSQLGetRequest as _immudb_schema_VerifiableSQLGetRequest, VerifiableSQLGetRequest__Output as _immudb_schema_VerifiableSQLGetRequest__Output } from '../../immudb/schema/VerifiableSQLGetRequest.js';
import type { VerifiableSetRequest as _immudb_schema_VerifiableSetRequest, VerifiableSetRequest__Output as _immudb_schema_VerifiableSetRequest__Output } from '../../immudb/schema/VerifiableSetRequest.js';
import type { VerifiableTx as _immudb_schema_VerifiableTx, VerifiableTx__Output as _immudb_schema_VerifiableTx__Output } from '../../immudb/schema/VerifiableTx.js';
import type { VerifiableTxRequest as _immudb_schema_VerifiableTxRequest, VerifiableTxRequest__Output as _immudb_schema_VerifiableTxRequest__Output } from '../../immudb/schema/VerifiableTxRequest.js';
import type { VerifiableZAddRequest as _immudb_schema_VerifiableZAddRequest, VerifiableZAddRequest__Output as _immudb_schema_VerifiableZAddRequest__Output } from '../../immudb/schema/VerifiableZAddRequest.js';
import type { ZAddRequest as _immudb_schema_ZAddRequest, ZAddRequest__Output as _immudb_schema_ZAddRequest__Output } from '../../immudb/schema/ZAddRequest.js';
import type { ZEntries as _immudb_schema_ZEntries, ZEntries__Output as _immudb_schema_ZEntries__Output } from '../../immudb/schema/ZEntries.js';
import type { ZScanRequest as _immudb_schema_ZScanRequest, ZScanRequest__Output as _immudb_schema_ZScanRequest__Output } from '../../immudb/schema/ZScanRequest.js';
